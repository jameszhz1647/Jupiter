package com.jameszhz.jupiter.controller;

import com.jameszhz.jupiter.entity.db.Item;
import com.jameszhz.jupiter.entity.request.FavoriteRequestBody;
import com.jameszhz.jupiter.service.FavoriteService;
...
public class FavoriteController {
    ...
    public void setFavoriteItem(@RequestBody FavoriteRequestBody requestBody, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (session == null) {  // not authorized
