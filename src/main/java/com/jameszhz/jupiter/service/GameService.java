...
import com.jameszhz.jupiter.entity.db.Item;
import com.jameszhz.jupiter.entity.db.ItemType;
...
public class GameService {
    private static final String TOKEN = "Bearer qmq8bvdkcwbjlww3ksp3eiai38rq8b";
    private static final String CLIENT_ID = "3fgg15615p4a2otqp9fcur2cr7hjve";
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) {
            ...
            return String.format(url, gameName); // replace %s with gameName (string)
        }
    }
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        // response is the input parameter
        ResponseHandler<String> responseHandler = response -> {
            ...
            return obj.getJSONArray("data").toString();   //return string
        };
        ...
        try {
            ...
            return httpclient.execute(request, responseHandler); //responseHandler is a callback func, 传入response
        } catch (IOException e) {
            e.printStackTrace();
            throw new TwitchException("Failed to get result from Twitch API");
        } finally {
